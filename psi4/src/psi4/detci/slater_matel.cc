...
double CIWavefunction::oneparticlematrix_element(SlaterDeterminant* I, SlaterDeterminant* J)
{
   int *common_socc1, *common_socc2;
   int sign=0;
   int nalp, nbet, nalp_same, nbet_same;
...
double CIWavefunction::twoparticlematrix_element(SlaterDeterminant* I, SlaterDeterminant* J)
{
   int *common_socc1, *common_socc2;
   int sign=0;
   int nalp, nbet, nalp_same, nbet_same;
